  ...
  return (
    <div className="h-full pb-12 lg:h-[calc(100vh-6rem)] flex justify-center pt-12">
      <div className="h-full w-full max-w-8xl flex items-center flex-col">
        <div className="w-full flex items-center justify-center flex-col md:flex-row gap-4 max-w-7xl">
        ...
        <div className=" mt-12 h-fit pb-12 min-h-[500px]  w-full max-w-7xl">
          <div className="h-full w-full flex gap-x-4 flex-col md:flex-row">
            <div className="h-full  w-[480px]  xl:pt-12">
              <h2 className="text-3xl md:text-5xl font-semibold text-gray-900 lg:max-w-[480px]">Let&apos;s work together</h2>
              <p className="text-lg md:text-2xl font-light text-gray-800 mt-3 lg:max-w-[450px]">
